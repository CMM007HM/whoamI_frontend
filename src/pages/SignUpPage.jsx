  ...
  const handleSubmit = async() => {
    ...
    if (formData.firstName === "" || formData.firstName.length < 2) {
      ...
      try {
        ...
        const response = await axios.post(`${process.env.REACT_APP_BASE_URL}api/users/`, dataCopy)
      ...
      <div className="w-[50%] sm:w-[100%] ml-[3%]">
        <div onClick={()=>navigate('/')} className="sticky font-nova mt-[4%] ml-[6%] cursor-pointer z-0 text-[32px] font-[400] top-0">
          {/* <img
            src={sdclogo}
            alt="logo"
            className="mt-[4%] w-[25%] ml-[6%] z-0"
          /> */}
          Whoami
        </div>
        <div className="my-[5%] ml-[6%] flex flex-col">
          <span className="font-[500] text-[20px] text-[#000000]">
            Set up your Whoami account
          </span>
          {/* <span className="font-[400] text-[16px] text-[#7C8DB5]">
