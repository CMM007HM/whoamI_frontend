    ...
    return (
        <div className="w-[90%] mt-[2.2rem] mr-[4%] font-poppins">
            ...
            <div className="flex flex-col mt-[4%] sm:text-center">
                ...
                <span className="font-[400] text-[#7C8DB5] text-[14px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
            </div>
            <div className="mt-14 flex justify-between sm:flex-col sm:mx-[5%]">
                <div className="flex flex-col">
                    <span className="font-[500] text-[16px]">Email us</span>
                    <span className="px-14 py-3 mt-2 text-[12px] sm:text-center font-[400] bg-white rounded-lg">Email: loremipsum@ipsumm.com</span>
                </div>
                <div className="flex flex-col">
