                    ...
                    <>
                      <div key={item._id} className="flex px-5 py-2 text-[14px] justify-between hover:bg-[#f1f1f1] rounded-md">
                        ...
                        <div className="flex gap-x-4">
                          ...
                          <button type="button" className="flex gap-x-2 items-center hover:cursor-pointer hover:text-[red] hover:bg-[#fff] max-h-8 bg-[red] px-4 py-2 rounded-md text-white"><BsTrashFill /></button>
                        </div>
