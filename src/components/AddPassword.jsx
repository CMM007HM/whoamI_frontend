...
import { createPassword, getPasswords } from "../features/passwords/passwordsActions"


const AddPassword = ({ openAddPasswordModal, setOpenAddPasswordModal }) => {
  ...
  if (!openAddPasswordModal) return null
  return (
    <div
    ...
    >
      <div className="relative flex w-[70%] sm:w-[90%] flex-col shadow-md gap-y-4 pr-[5%] pl-[2%] pb-[2%] bg-white self-start mt-32 rounded-lg max-w-screen-md">
        <div className="my-[4%] text-[16px]">Add Password</div>
        <form>
