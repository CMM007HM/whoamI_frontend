...
import { createCategory, updateCategory, getCategory } from './categoryActions';
...
const categorySlice = createSlice({
    ...
    extraReducers: {
        ...
        [updateCategory.fulfilled]: (state, { payload }) => {
            const updatedCategory = state.category.map((category) => category._id === payload.id ? payload : category);
            state.loading = false;
